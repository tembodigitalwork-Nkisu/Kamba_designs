...
const policy = [
  ...
  ["3 – 6 mo", "Lead time for most pieces. Express orders possible (full upfront payment) when the calendar allows."],
          ...
          <aside className="lg:col-span-4">
            ...
            <div className="mt-8 border-t border-ivory-200 pt-6">
              ...
              <ul className="mt-3 text-sm text-ink-950 space-y-1">
                <li className="flex justify-between"><span>Mon – Sat</span><span>By appointment</span></li>
